...
public class ChangePasswordJDialog extends javax.swing.JDialog implements ChangePasswordController {
    ...
    public void save() {
        ...
        // Dòng này kiểm tra tên đăng nhập nhập vào có khớp với người dùng đang đăng
        // nhập không
        if (!newpass.equals(confirm)) {
            XDialog.error("Xác nhận mật khẩu không đúng!");
        }
        // Dòng này so sánh tên đăng nhập nhập vào với tên đăng nhập của người dùng HIỆN
        // TẠI
        else if (!username.equals(XAuth.user.getUsername())) {
            XDialog.error("Sai tên đăng nhập!");
        }
        // Dòng này so sánh mật khẩu hiện tại nhập vào với mật khẩu của người dùng HIỆN
        // TẠI
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/logoTonHoaMai_trang-Photoroom.png"))); // NOI18N
